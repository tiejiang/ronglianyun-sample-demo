 ...
 */
package com.example.safeboxmonitor.ui.layoutcontrol;
	...
	private OnClickListener l = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.layout_call_mute:
                ...
                mCallMute.setImageResource(mute ? R.mipmap.ec_call_interface_mute_on : R.mipmap.ec_call_interface_mute);

                break;
			case R.id.layout_call_handfree:
				VoIPCallHelper.setHandFree();
                boolean handFree = VoIPCallHelper.getHandFree();
                mCallHandFree .setImageResource(handFree ? R.mipmap.ec_call_interface_hands_free_on : R.mipmap.ec_call_interface_hands_free);
				break;
