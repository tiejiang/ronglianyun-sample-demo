...
import com.example.safeboxmonitor.util.ECNotificationManager;
...
//            LogUtil.d(TAG , "username " + clientUser.getUserName() + " , userphone " + clientUser.getUserId());
     ...
     * @param number 呼叫号码
     */
    public static String makeCall(CallType callType , String number) {
        initCall();
...
//            LogUtil.e(TAG , "make call error : ECVoIPCallManager null");
    ...
    public static void makeCallBack(CallType callType , String number) {
        initCall();
        if(getInstance().mCallInterface == null) {
//            LogUtil.e(TAG , "make call error : ECVoIPCallManager null");
            return ;
