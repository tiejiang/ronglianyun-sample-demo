...
import com.example.safeboxmonitor.util.DateUtil;
...
/**
 * @author Jorstin Chan@容联•云通讯----》modified by tiejiang
 * @date 20161214
 * @version 4.0
 */
...
//		ECChatManager mManager = ECDevice.getECChatManager();
//		mManager.sendMessage(msg, new ECChatManager.OnSendMessageListener() {
//
//			@Override
...
//				LogUtil.d("TIEJIANG---[IMChattingHelper]-send message");// add by tiejiang
//			}
			if (getInstance() != null){
//				manager.sendMessage(msg, getInstance().mListener);// add by tiejiang
...
//		}else {
//			return IMessageSqlManager.insertIMessage(msg,
//					Direction.SEND.ordinal());
//		}
		return  0; //add by tiejiang
...
//		// 组建一个待发送的ECMessage
//		ECMessage msg = ECMessage.createECMessage(Type.RICH_TEXT);
//		// 设置消息接收者
//		msg.setTo(to);
//		// 创建一个文本消息体，并添加到消息对象中
