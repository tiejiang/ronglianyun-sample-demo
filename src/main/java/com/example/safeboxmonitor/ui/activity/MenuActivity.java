...
public class MenuActivity extends Activity implements IMChattingHelper.OnMessageReportCallback, View.OnClickListener {
    ...
    private String nickName = "15919939276";
    private String contactID = "15919939276";

    String mobile = "18665889098";
    String pass = "";
...
//msg.setTo(mRecipients);
        msg.setTo("15919939276"); // attenion this number is not the login number! / modified by tiejiang
